...
/*
        ...
        Crucible build 360229  Released December 1, 2011.
*/
?>
...
<?php
	...
	if( !$connections ) die('Couldn\'t connect to database.');
...
<br>
	<center>
		<table class=mainframe>
			<tr><th class=weblogo colspan=2>&nbsp;</th></tr>
			<tr>
				<td class=webmenu><?php include( 'menu.php' ); ?></td>
				<td class=webcontent><?php include( 'main.php' ); ?></td>
			</tr>
			<tr><th colspan=2><?php include( 'footer.php' ); ?>
		</table>
