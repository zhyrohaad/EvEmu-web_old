	...
	}else if( ( isset( $_POST[ 'username' ] ) ) && ( isset( $_POST[ 'password' ] ) ) )
	{
		if( ( empty( $_POST[ 'username' ] ) ) )
		{
			...
			if( $row = mysqli_fetch_array( $gameserver_result, MYSQLI_ASSOC ) )
			{
				if( $row[ 'banned' ] == 1)
				{
					echo '<div id="theader"><table><tr><th><center><font style="color: rgb( 255, 0, 0 );"><strong>Error</strong></font></th></tr><tr><td><center>You\'re banned and not able to login</center></td></tr></table></div>';
...
<tr><th colspan=2>Welcome to EVEmu Portal, please fill the form in order to log in.</th></tr>
...
*/?>
<BR><BR><BR><BR>
<h3><font color=yellow>Login has been disabled</font></h3>
<BR><BR><BR>
