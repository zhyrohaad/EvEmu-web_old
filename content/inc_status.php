...
'db'=>'EVE_Incursion'			// Name of your EVE Emulator database
);
...
?>
<tr><td colspan="6" align="center" class="content"><font color=orange><strong><h3>Adrasteia (Incursion) {Not Avalible}</h3></strong></font></td></tr>
<?php
...
if( $players && $online ) {
	...
	if($result=mysql_query($query,$db)) {
		while($row=mysql_fetch_array($result)) {
			...
			printf('<td class="content">&nbsp;%s</td></tr>',$row[6]);
		}
	} else {
